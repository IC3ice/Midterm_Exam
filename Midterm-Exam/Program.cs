...
class Program{
    ...
    static void TotalParcipitant(){
        Console.Clear();
        Program.collegeList.TotalCollege();
        Program.collegeList.TotalStudent();
        Program.collegeList.TotalTeacher();
    ...
    static void NonRegisInputNewCollegeFromKeyboard() {
            ...
            Program.collegeList.AddNewCollege(college);
    ...
    static void NonRegisInputNewStudentFromKeyboard() {
            ...
            Program.collegeList.AddNewStudent(student);
            BackToNonRegisteredMenu();
        }
    ...
    static void NonRegisInputNewTeacherFromKeyboard() {
            ...
            Program.collegeList.AddNewTeacher(teacher);
            BackToNonRegisteredMenu();
    }
...
/******************************************************************/
    ...
    static void PresentRegisteredMenu(RegisteredMenu registeredMenu) {
        switch (registeredMenu) {
            case RegisteredMenu.RegisterEvent:
                ...
                break;
            case RegisteredMenu.CollegeInEvent:
                ShowCollegeInEvent();
                break;
    ...
    static void ShowCollegeInEvent() {
        ...
        Program.collegeList.FetchCollegeList();
    ...
    static string GetGrade(){
        ...
        Console.Write("pls select your high school grade :");
        int input = int.Parse(Console.ReadLine());
        if(input == 1) {
    ...
    static string GetCar(){
        Console.Clear();
        Console.WriteLine("******************");
        Console.WriteLine("Do you have car with you?");
    ...
    static void InputAdmin(){
        Console.WriteLine("Please input your admin accout to submit");
        Console.WriteLine("*****************************************");
